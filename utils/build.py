...
def main(argv=None):
	...
	parser.add_argument('--output', default='../build/fuiAdapter.js')
	...
	if args.minify is True:
		...
		source = ' '.join(sources)
		output_min = '../build/fuiAdapter.min.js'
		...
		with open(output_min,'w') as f: f.write('// fuiAdapter.js - http://github.com/AmicableNinja/fuiAdapter.js\n' + text )
