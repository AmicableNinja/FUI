...
FUI.sbool.prototype.evaluate=function(a){var b=!1,c;for(c in this.ors){switch(typeof this.ors[c]){case "object":this.ors[c].evaluate?b=this.ors[c].evaluate(a)||b:FUI.debug.error(10,["unknown object type, ors",this.ors[c],c,this.ors]);break;case "undefined":return!1;case "boolean":b=this.ors[c]||b;break;case "function":b=this.ors[c](a)||b;break;default:FUI.debug.error(10,["not implemented yet, ors",this.ors[c],c,this.ors])}FUI.debug.log(10,["ors isTrue",b,"on n",c]);if(b)return!0}for(c in this.ands)switch(typeof this.ands[c]){case "object":this.ands[c].evaluate?
(b=this.ands[c].evaluate(a)&&b,FUI.debug.log(10,["isTrue",b,"on n",c])):FUI.debug.error(10,["unknown object type, ands",this.ands[c],c,this.ands]);break;case "undefined":return!1;case "boolean":b=this.ors[c]&&b;break;case "function":b=this.ors[c](a)&&b;break;default:FUI.debug.error(10,["not implemented yet, ands",this.ands[c],c,this.ands])}FUI.debug.log(10,["ands isTrue",b,"on n",c]);return b};
var otherNotation_imp=new FUI.sbool([1,6],[2,5,new FUI.sbool([3,4])]),otherNotation_impBool=new FUI.sbool([!1,!1],[!0,!0,new FUI.sbool([!1,!0])]);FUI.driver={};
...
__t1.Left=[FUI.BUTTON_ARROW_LEFT];__t1.PageDown=[FUI.BUTTON_PAGE_DOWN];__t1.PageUp=[FUI.BUTTON_PAGE_UP];__t1.Pause=[FUI.BUTTON_PAUSE_BREAK];__t1.PrintScreen=[FUI.BUTTON_PRINT_SCREEN];__t1.Right=[FUI.BUTTON_ARROW_RIGHT];__t1.Scroll=[FUI.BUTTON_SCROLL_LOCK];__t1.Select=[FUI.BUTTON_SELECT];__t1.Up=[FUI.BUTTON_ARROW_UP];window.__t1_ORIG?(__t1=window.__t1_ORIG,delete window.__t1_ORIG):__t1=void 0;window.__t2_ORIG?(__t2=window.__t2_ORIG,delete window.__t2_ORIG):__t2=void 0;FUI.driver.browser=function(){};FUI.driver.browser.prototype={constructor:FUI.driver.browser,mouse:function(){},keyboard:function(){},touches:function(){}};FUI.driver.browser.prototype.keyboard=function(a){var a=a||{},b=a.keyCode||a.which,c=null,c=FUI.driver.keyboard.prototype.buttonTable[b]?FUI.driver.keyboard.prototype.buttonTable[b]:b;c[0]&&(c=c[0]);return{buttonCode:c,rawEventData:a}};
